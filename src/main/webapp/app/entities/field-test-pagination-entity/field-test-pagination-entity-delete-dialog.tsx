  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisReactApp.fieldTestPaginationEntity.delete.question">
          <Translate
            contentKey="travisReactApp.fieldTestPaginationEntity.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="my-prefix-confirm-delete-fieldTestPaginationEntity" color="danger" onClick={this.confirmDelete}>
