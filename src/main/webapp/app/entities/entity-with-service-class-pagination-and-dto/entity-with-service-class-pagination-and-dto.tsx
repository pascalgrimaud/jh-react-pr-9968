    ...
    return (
      <div>
        <h2 id="entity-with-service-class-pagination-and-dto-heading">
          <Translate contentKey="travisReactApp.entityWithServiceClassPaginationAndDTO.home.title">
            Entity With Service Class Pagination And DTOS
          </Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="travisReactApp.entityWithServiceClassPaginationAndDTO.home.createLabel">
        ...
        <div className="table-responsive">
          {entityWithServiceClassPaginationAndDTOList && entityWithServiceClassPaginationAndDTOList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="travisReactApp.entityWithServiceClassPaginationAndDTO.home.notFound">
