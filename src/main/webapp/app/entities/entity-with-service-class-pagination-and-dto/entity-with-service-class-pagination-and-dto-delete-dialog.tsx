  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisReactApp.entityWithServiceClassPaginationAndDTO.delete.question">
          <Translate
            contentKey="travisReactApp.entityWithServiceClassPaginationAndDTO.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="my-prefix-confirm-delete-entityWithServiceClassPaginationAndDTO" color="danger" onClick={this.confirmDelete}>
