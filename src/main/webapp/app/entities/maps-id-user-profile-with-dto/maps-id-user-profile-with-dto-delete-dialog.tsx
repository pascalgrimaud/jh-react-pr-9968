  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisReactApp.mapsIdUserProfileWithDTO.delete.question">
          <Translate
            contentKey="travisReactApp.mapsIdUserProfileWithDTO.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="my-prefix-confirm-delete-mapsIdUserProfileWithDTO" color="danger" onClick={this.confirmDelete}>
