  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisReactApp.fieldTestServiceImplEntity.delete.question">
          <Translate
            contentKey="travisReactApp.fieldTestServiceImplEntity.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="my-prefix-confirm-delete-fieldTestServiceImplEntity" color="danger" onClick={this.confirmDelete}>
