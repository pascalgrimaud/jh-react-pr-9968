  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisReactApp.fieldTestServiceClassEntity.delete.question">
          <Translate
            contentKey="travisReactApp.fieldTestServiceClassEntity.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="my-prefix-confirm-delete-fieldTestServiceClassEntity" color="danger" onClick={this.confirmDelete}>
