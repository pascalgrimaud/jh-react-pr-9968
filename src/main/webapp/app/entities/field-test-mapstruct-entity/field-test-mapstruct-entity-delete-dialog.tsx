  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisReactApp.fieldTestMapstructEntity.delete.question">
          <Translate
            contentKey="travisReactApp.fieldTestMapstructEntity.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="my-prefix-confirm-delete-fieldTestMapstructEntity" color="danger" onClick={this.confirmDelete}>
