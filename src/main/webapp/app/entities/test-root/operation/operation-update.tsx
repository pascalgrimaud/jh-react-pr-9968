    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="travisReactApp.testRootOperation.home.createOrEditLabel">
              <Translate contentKey="travisReactApp.testRootOperation.home.createOrEditLabel">Create or edit a Operation</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : operationEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="dateLabel" for="operation-date">
                    <Translate contentKey="travisReactApp.testRootOperation.date">Date</Translate>
                  </Label>
                  <AvInput
                    id="operation-date"
                    type="datetime-local"
                ...
                <AvGroup>
                  <Label id="amountLabel" for="operation-amount">
                    <Translate contentKey="travisReactApp.testRootOperation.amount">Amount</Translate>
                  </Label>
                  <AvField
                    id="operation-amount"
                    type="text"
                ...
                <AvGroup>
                  <Label for="operation-label">
                    <Translate contentKey="travisReactApp.testRootOperation.label">Label</Translate>
                  </Label>
                  <AvInput
                    id="operation-label"
                    type="select"
