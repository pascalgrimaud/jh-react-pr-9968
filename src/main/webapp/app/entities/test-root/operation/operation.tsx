    ...
    return (
      <div>
        <h2 id="operation-heading">
          <Translate contentKey="travisReactApp.testRootOperation.home.title">Operations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="travisReactApp.testRootOperation.home.createLabel">Create a new Operation</Translate>
          </Link>
        </h2>
          ...
          >
            {operationList && operationList.length > 0 ? (
                ...
                <thead>
                  <tr>
                    ...
                    <th className="hand" onClick={this.sort('date')}>
                      <Translate contentKey="travisReactApp.testRootOperation.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('description')}>
                      <Translate contentKey="travisReactApp.testRootOperation.description">Description</Translate>{' '}
                      <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('amount')}>
                      <Translate contentKey="travisReactApp.testRootOperation.amount">Amount</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
                      <Translate contentKey="travisReactApp.testRootOperation.bankAccount">Bank Account</Translate>{' '}
                      <FontAwesomeIcon icon="sort" />
                    </th>
                    <th />
                  </tr>
              ...
              <div className="alert alert-warning">
                <Translate contentKey="travisReactApp.testRootOperation.home.notFound">No Operations found</Translate>
              </div>
            )}
          </InfiniteScroll>
        </div>
