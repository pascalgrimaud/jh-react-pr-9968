  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="travisReactApp.testRootLabel.detail.title">Label</Translate> [<b>{labelEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            <dt>
              <span id="labelName">
                <Translate contentKey="travisReactApp.testRootLabel.labelName">Label Name</Translate>
              </span>
            </dt>
