    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="travisReactApp.entityWithDTO.home.createOrEditLabel">
              <Translate contentKey="travisReactApp.entityWithDTO.home.createOrEditLabel">Create or edit a EntityWithDTO</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
