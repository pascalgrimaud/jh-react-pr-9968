  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisReactApp.entityWithDTO.delete.question">
          <Translate contentKey="travisReactApp.entityWithDTO.delete.question" interpolate={{ id: entityWithDTOEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="my-prefix-confirm-delete-entityWithDTO" color="danger" onClick={this.confirmDelete}>
