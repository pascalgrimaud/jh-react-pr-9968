    ...
    return (
      <div>
        <h2 id="entity-with-dto-heading">
          <Translate contentKey="travisReactApp.entityWithDTO.home.title">Entity With DTOS</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="travisReactApp.entityWithDTO.home.createLabel">Create a new Entity With DTO</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {entityWithDTOList && entityWithDTOList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="travisReactApp.entityWithDTO.home.notFound">No Entity With DTOS found</Translate>
            </div>
          )}
        </div>
      </div>
