    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="travisReactApp.entityWithServiceImplAndDTO.home.createOrEditLabel">
              <Translate contentKey="travisReactApp.entityWithServiceImplAndDTO.home.createOrEditLabel">
