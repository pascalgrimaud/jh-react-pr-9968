  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisReactApp.entityWithServiceImplAndDTO.delete.question">
          <Translate
            contentKey="travisReactApp.entityWithServiceImplAndDTO.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="my-prefix-confirm-delete-entityWithServiceImplAndDTO" color="danger" onClick={this.confirmDelete}>
