    ...
    return (
      <div>
        <h2 id="entity-with-service-impl-and-dto-heading">
          <Translate contentKey="travisReactApp.entityWithServiceImplAndDTO.home.title">Entity With Service Impl And DTOS</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="travisReactApp.entityWithServiceImplAndDTO.home.createLabel">
        ...
        <div className="table-responsive">
          {entityWithServiceImplAndDTOList && entityWithServiceImplAndDTOList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="travisReactApp.entityWithServiceImplAndDTO.home.notFound">
