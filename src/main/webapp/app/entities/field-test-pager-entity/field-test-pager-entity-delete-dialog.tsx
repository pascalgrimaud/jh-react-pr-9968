...
export interface IFieldTestPagerEntityDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisReactApp.fieldTestPagerEntity.delete.question">
          <Translate contentKey="travisReactApp.fieldTestPagerEntity.delete.question" interpolate={{ id: fieldTestPagerEntityEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="my-prefix-confirm-delete-fieldTestPagerEntity" color="danger" onClick={this.confirmDelete}>
