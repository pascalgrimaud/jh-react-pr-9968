    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="travisReactApp.entityWithServiceImplPaginationAndDTO.home.createOrEditLabel">
              <Translate contentKey="travisReactApp.entityWithServiceImplPaginationAndDTO.home.createOrEditLabel">
