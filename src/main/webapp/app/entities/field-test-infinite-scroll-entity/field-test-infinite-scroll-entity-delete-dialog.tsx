  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisReactApp.fieldTestInfiniteScrollEntity.delete.question">
          <Translate
            contentKey="travisReactApp.fieldTestInfiniteScrollEntity.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="my-prefix-confirm-delete-fieldTestInfiniteScrollEntity" color="danger" onClick={this.confirmDelete}>
