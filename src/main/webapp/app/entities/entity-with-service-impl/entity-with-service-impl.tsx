    ...
    return (
      <div>
        <h2 id="entity-with-service-impl-heading">
          <Translate contentKey="travisReactApp.entityWithServiceImpl.home.title">Entity With Service Impls</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="travisReactApp.entityWithServiceImpl.home.createLabel">Create a new Entity With Service Impl</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {entityWithServiceImplList && entityWithServiceImplList.length > 0 ? (
            <Table responsive aria-describedby="entity-with-service-impl-heading">
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="travisReactApp.entityWithServiceImpl.clara">Clara</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="travisReactApp.entityWithServiceImpl.home.notFound">No Entity With Service Impls found</Translate>
            </div>
          )}
        </div>
      </div>
