  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisReactApp.entityWithServiceImplAndPagination.delete.question">
          <Translate
            contentKey="travisReactApp.entityWithServiceImplAndPagination.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="my-prefix-confirm-delete-entityWithServiceImplAndPagination" color="danger" onClick={this.confirmDelete}>
