    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="travisReactApp.entityWithServiceImplAndPagination.home.createOrEditLabel">
              <Translate contentKey="travisReactApp.entityWithServiceImplAndPagination.home.createOrEditLabel">
