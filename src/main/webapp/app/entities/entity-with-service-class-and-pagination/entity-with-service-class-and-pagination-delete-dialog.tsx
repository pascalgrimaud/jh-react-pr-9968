  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisReactApp.entityWithServiceClassAndPagination.delete.question">
          <Translate
            contentKey="travisReactApp.entityWithServiceClassAndPagination.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="my-prefix-confirm-delete-entityWithServiceClassAndPagination" color="danger" onClick={this.confirmDelete}>
