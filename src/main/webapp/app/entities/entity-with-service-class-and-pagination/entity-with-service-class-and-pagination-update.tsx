    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="travisReactApp.entityWithServiceClassAndPagination.home.createOrEditLabel">
              <Translate contentKey="travisReactApp.entityWithServiceClassAndPagination.home.createOrEditLabel">
