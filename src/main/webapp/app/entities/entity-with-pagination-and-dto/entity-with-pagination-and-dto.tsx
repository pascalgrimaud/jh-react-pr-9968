    ...
    return (
      <div>
        <h2 id="entity-with-pagination-and-dto-heading">
          <Translate contentKey="travisReactApp.entityWithPaginationAndDTO.home.title">Entity With Pagination And DTOS</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="travisReactApp.entityWithPaginationAndDTO.home.createLabel">
        ...
        <div className="table-responsive">
          {entityWithPaginationAndDTOList && entityWithPaginationAndDTOList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('lea')}>
                    <Translate contentKey="travisReactApp.entityWithPaginationAndDTO.lea">Lea</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="travisReactApp.entityWithPaginationAndDTO.home.notFound">
