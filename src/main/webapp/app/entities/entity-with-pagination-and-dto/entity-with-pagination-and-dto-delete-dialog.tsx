  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisReactApp.entityWithPaginationAndDTO.delete.question">
          <Translate
            contentKey="travisReactApp.entityWithPaginationAndDTO.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="my-prefix-confirm-delete-entityWithPaginationAndDTO" color="danger" onClick={this.confirmDelete}>
