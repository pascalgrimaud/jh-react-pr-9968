    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="travisReactApp.entityWithPaginationAndDTO.home.createOrEditLabel">
              <Translate contentKey="travisReactApp.entityWithPaginationAndDTO.home.createOrEditLabel">
              ...
              <AvForm model={isNew ? {} : entityWithPaginationAndDTOEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="leaLabel" for="entity-with-pagination-and-dto-lea">
                    <Translate contentKey="travisReactApp.entityWithPaginationAndDTO.lea">Lea</Translate>
                  </Label>
