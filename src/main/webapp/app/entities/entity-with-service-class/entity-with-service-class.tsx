    ...
    return (
      <div>
        <h2 id="entity-with-service-class-heading">
          <Translate contentKey="travisReactApp.entityWithServiceClass.home.title">Entity With Service Classes</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="travisReactApp.entityWithServiceClass.home.createLabel">
        ...
        <div className="table-responsive">
          {entityWithServiceClassList && entityWithServiceClassList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="travisReactApp.entityWithServiceClass.home.notFound">No Entity With Service Classes found</Translate>
            </div>
          )}
        </div>
      </div>
