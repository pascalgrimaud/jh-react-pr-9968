...
/**
 * Criteria class for the {@link io.github.jhipster.travis.domain.BankAccount} entity. This class is used
 * in {@link io.github.jhipster.travis.web.rest.BankAccountResource} to receive all the possible filtering options from
...
public class BankAccountCriteria implements Serializable, Criteria {
    ...
    public BankAccountCriteria(BankAccountCriteria other){
        ...
        this.meanQueueDuration = other.meanQueueDuration == null ? null : other.meanQueueDuration.copy();
    ...
    public String toString() {
        return "BankAccountCriteria{" +
                ...
                (meanQueueDuration != null ? "meanQueueDuration=" + meanQueueDuration + ", " : "") +
