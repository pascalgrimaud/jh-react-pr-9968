...
public class FieldTestPagerEntity implements Serializable {
    ...
    @NotNull
    @Column(name = "big_decimal_required_jade", precision = 21, scale = 2, nullable = false)
    private BigDecimal bigDecimalRequiredJade;

    @DecimalMin(value = "0")
    @Column(name = "big_decimal_min_jade", precision = 21, scale = 2)
    private BigDecimal bigDecimalMinJade;

    @DecimalMax(value = "100")
    @Column(name = "big_decimal_max_jade", precision = 21, scale = 2)
    ...
    @Column(name = "duration_jade")
    private Duration durationJade;

    @NotNull
    @Column(name = "duration_required_jade", nullable = false)
    private Duration durationRequiredJade;
    ...
    @Type(type = "uuid-char")
    @Column(name = "uuid_jade", length = 36)
    private UUID uuidJade;

    @NotNull
    @Type(type = "uuid-char")
    @Column(name = "uuid_required_jade", length = 36, nullable = false)
    private UUID uuidRequiredJade;
    ...
    public Duration getDurationJade() {
        return durationJade;
    }

    public FieldTestPagerEntity durationJade(Duration durationJade) {
        this.durationJade = durationJade;
        return this;
    }

    public void setDurationJade(Duration durationJade) {
        this.durationJade = durationJade;
    }

    public Duration getDurationRequiredJade() {
        return durationRequiredJade;
    }

    public FieldTestPagerEntity durationRequiredJade(Duration durationRequiredJade) {
        this.durationRequiredJade = durationRequiredJade;
        return this;
    }

    public void setDurationRequiredJade(Duration durationRequiredJade) {
        this.durationRequiredJade = durationRequiredJade;
    }
    ...
    public UUID getUuidJade() {
        return uuidJade;
    }

    public FieldTestPagerEntity uuidJade(UUID uuidJade) {
        this.uuidJade = uuidJade;
        return this;
    }

    public void setUuidJade(UUID uuidJade) {
        this.uuidJade = uuidJade;
    }

    public UUID getUuidRequiredJade() {
        return uuidRequiredJade;
    }

    public FieldTestPagerEntity uuidRequiredJade(UUID uuidRequiredJade) {
        this.uuidRequiredJade = uuidRequiredJade;
        return this;
    }

    public void setUuidRequiredJade(UUID uuidRequiredJade) {
        this.uuidRequiredJade = uuidRequiredJade;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FieldTestPagerEntity)) {
            return false;
        }
        return id != null && id.equals(((FieldTestPagerEntity) o).id);
    }
    ...
    public String toString() {
        return "FieldTestPagerEntity{" +
            ...
            ", durationJade='" + getDurationJade() + "'" +
            ", durationRequiredJade='" + getDurationRequiredJade() + "'" +
            ...
            ", uuidJade='" + getUuidJade() + "'" +
            ", uuidRequiredJade='" + getUuidRequiredJade() + "'" +
