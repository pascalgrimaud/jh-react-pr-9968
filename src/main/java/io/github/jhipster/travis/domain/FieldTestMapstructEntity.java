...
public class FieldTestMapstructEntity implements Serializable {
    ...
    @NotNull
    @Column(name = "big_decimal_required_eva", precision = 21, scale = 2, nullable = false)
    private BigDecimal bigDecimalRequiredEva;

    @DecimalMin(value = "0")
    @Column(name = "big_decimal_min_eva", precision = 21, scale = 2)
    private BigDecimal bigDecimalMinEva;

    @DecimalMax(value = "100")
    @Column(name = "big_decimal_max_eva", precision = 21, scale = 2)
    ...
    @Column(name = "duration_eva")
    private Duration durationEva;

    @NotNull
    @Column(name = "duration_required_eva", nullable = false)
    ...
    @Type(type = "uuid-char")
    @Column(name = "uuid_eva", length = 36)
    private UUID uuidEva;

    @NotNull
    @Type(type = "uuid-char")
    @Column(name = "uuid_required_eva", length = 36, nullable = false)
    ...
    public FieldTestMapstructEntity durationEva(Duration durationEva) {
    ...
    public FieldTestMapstructEntity durationRequiredEva(Duration durationRequiredEva) {
    ...
    public FieldTestMapstructEntity uuidEva(UUID uuidEva) {
    ...
    public FieldTestMapstructEntity uuidRequiredEva(UUID uuidRequiredEva) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FieldTestMapstructEntity)) {
            return false;
        }
        return id != null && id.equals(((FieldTestMapstructEntity) o).id);
    }
