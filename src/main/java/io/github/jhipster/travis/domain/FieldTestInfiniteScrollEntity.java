...
public class FieldTestInfiniteScrollEntity implements Serializable {
    ...
    @NotNull
    @Column(name = "big_decimal_required_hugo", precision = 21, scale = 2, nullable = false)
    private BigDecimal bigDecimalRequiredHugo;

    @DecimalMin(value = "0")
    @Column(name = "big_decimal_min_hugo", precision = 21, scale = 2)
    private BigDecimal bigDecimalMinHugo;

    @DecimalMax(value = "100")
    @Column(name = "big_decimal_max_hugo", precision = 21, scale = 2)
    ...
    @Column(name = "duration_hugo")
    private Duration durationHugo;

    @NotNull
    @Column(name = "duration_required_hugo", nullable = false)
    ...
    @Type(type = "uuid-char")
    @Column(name = "uuid_hugo", length = 36)
    private UUID uuidHugo;

    @NotNull
    @Type(type = "uuid-char")
    @Column(name = "uuid_required_hugo", length = 36, nullable = false)
