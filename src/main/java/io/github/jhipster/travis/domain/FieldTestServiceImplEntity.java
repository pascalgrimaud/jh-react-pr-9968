...
public class FieldTestServiceImplEntity implements Serializable {
    ...
    @NotNull
    @Column(name = "big_decimal_required_mika", precision = 21, scale = 2, nullable = false)
    private BigDecimal bigDecimalRequiredMika;

    @DecimalMin(value = "0")
    @Column(name = "big_decimal_min_mika", precision = 21, scale = 2)
    private BigDecimal bigDecimalMinMika;

    @DecimalMax(value = "100")
    @Column(name = "big_decimal_max_mika", precision = 21, scale = 2)
    ...
    @Column(name = "duration_mika")
    private Duration durationMika;

    @NotNull
    @Column(name = "duration_required_mika", nullable = false)
    ...
    @Type(type = "uuid-char")
    @Column(name = "uuid_mika", length = 36)
    private UUID uuidMika;

    @NotNull
    @Type(type = "uuid-char")
    @Column(name = "uuid_required_mika", length = 36, nullable = false)
