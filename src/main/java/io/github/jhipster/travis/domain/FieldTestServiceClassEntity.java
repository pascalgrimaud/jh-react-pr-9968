...
public class FieldTestServiceClassEntity implements Serializable {
    ...
    @NotNull
    @Column(name = "big_decimal_required_bob", precision = 21, scale = 2, nullable = false)
    private BigDecimal bigDecimalRequiredBob;

    @DecimalMin(value = "0")
    @Column(name = "big_decimal_min_bob", precision = 21, scale = 2)
    private BigDecimal bigDecimalMinBob;

    @DecimalMax(value = "100")
    @Column(name = "big_decimal_max_bob", precision = 21, scale = 2)
    ...
    @Column(name = "duration_bob")
    private Duration durationBob;

    @NotNull
    @Column(name = "duration_required_bob", nullable = false)
    ...
    @Type(type = "uuid-char")
    @Column(name = "uuid_bob", length = 36)
    private UUID uuidBob;

    @NotNull
    @Type(type = "uuid-char")
    @Column(name = "uuid_required_bob", length = 36, nullable = false)
    ...
    public FieldTestServiceClassEntity durationBob(Duration durationBob) {
    ...
    public FieldTestServiceClassEntity durationRequiredBob(Duration durationRequiredBob) {
    ...
    public FieldTestServiceClassEntity uuidBob(UUID uuidBob) {
    ...
    public FieldTestServiceClassEntity uuidRequiredBob(UUID uuidRequiredBob) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FieldTestServiceClassEntity)) {
            return false;
        }
        return id != null && id.equals(((FieldTestServiceClassEntity) o).id);
    }
