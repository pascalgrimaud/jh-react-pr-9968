...
public class FieldTestPaginationEntity implements Serializable {
    ...
    @NotNull
    @Column(name = "big_decimal_required_alice", precision = 21, scale = 2, nullable = false)
    private BigDecimal bigDecimalRequiredAlice;

    @DecimalMin(value = "0")
    @Column(name = "big_decimal_min_alice", precision = 21, scale = 2)
    private BigDecimal bigDecimalMinAlice;

    @DecimalMax(value = "100")
    @Column(name = "big_decimal_max_alice", precision = 21, scale = 2)
    ...
    @Column(name = "duration_alice")
    private Duration durationAlice;

    @NotNull
    @Column(name = "duration_required_alice", nullable = false)
    ...
    @Type(type = "uuid-char")
    @Column(name = "uuid_alice", length = 36)
    private UUID uuidAlice;

    @NotNull
    @Type(type = "uuid-char")
    @Column(name = "uuid_required_alice", length = 36, nullable = false)
