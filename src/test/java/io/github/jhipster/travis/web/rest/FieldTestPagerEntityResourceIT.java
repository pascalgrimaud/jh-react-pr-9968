...
/**
 * Integration tests for the {@link FieldTestPagerEntityResource} REST controller.
 */
@SpringBootTest(classes = TravisReactApp.class)
public class FieldTestPagerEntityResourceIT {
    ...
    private static final Duration DEFAULT_DURATION_JADE = Duration.ofHours(6);
    private static final Duration UPDATED_DURATION_JADE = Duration.ofHours(12);

    private static final Duration DEFAULT_DURATION_REQUIRED_JADE = Duration.ofHours(6);
    private static final Duration UPDATED_DURATION_REQUIRED_JADE = Duration.ofHours(12);
    ...
    private static final UUID DEFAULT_UUID_JADE = UUID.randomUUID();
    private static final UUID UPDATED_UUID_JADE = UUID.randomUUID();

    private static final UUID DEFAULT_UUID_REQUIRED_JADE = UUID.randomUUID();
    private static final UUID UPDATED_UUID_REQUIRED_JADE = UUID.randomUUID();
    ...
    public static FieldTestPagerEntity createEntity(EntityManager em) {
        FieldTestPagerEntity fieldTestPagerEntity = new FieldTestPagerEntity()
            ...
            .durationJade(DEFAULT_DURATION_JADE)
            .durationRequiredJade(DEFAULT_DURATION_REQUIRED_JADE)
            ...
            .uuidJade(DEFAULT_UUID_JADE)
            .uuidRequiredJade(DEFAULT_UUID_REQUIRED_JADE)
     ...
     * if they test an entity which requires the current entity.
     */
    public static FieldTestPagerEntity createUpdatedEntity(EntityManager em) {
        FieldTestPagerEntity fieldTestPagerEntity = new FieldTestPagerEntity()
            ...
            .durationJade(UPDATED_DURATION_JADE)
            .durationRequiredJade(UPDATED_DURATION_REQUIRED_JADE)
            ...
            .uuidJade(UPDATED_UUID_JADE)
            .uuidRequiredJade(UPDATED_UUID_REQUIRED_JADE)
    ...
    public void createFieldTestPagerEntity() throws Exception {
        ...
        assertThat(testFieldTestPagerEntity.getDurationJade()).isEqualTo(DEFAULT_DURATION_JADE);
        assertThat(testFieldTestPagerEntity.getDurationRequiredJade()).isEqualTo(DEFAULT_DURATION_REQUIRED_JADE);
        ...
        assertThat(testFieldTestPagerEntity.getUuidJade()).isEqualTo(DEFAULT_UUID_JADE);
        assertThat(testFieldTestPagerEntity.getUuidRequiredJade()).isEqualTo(DEFAULT_UUID_REQUIRED_JADE);
    ...
    @Test
    @Transactional
    public void checkDurationRequiredJadeIsRequired() throws Exception {
        int databaseSizeBeforeTest = fieldTestPagerEntityRepository.findAll().size();
        // set the field null
        fieldTestPagerEntity.setDurationRequiredJade(null);
    ...
    @Test
    @Transactional
    public void checkUuidRequiredJadeIsRequired() throws Exception {
        int databaseSizeBeforeTest = fieldTestPagerEntityRepository.findAll().size();
        // set the field null
        fieldTestPagerEntity.setUuidRequiredJade(null);
    ...
    public void getAllFieldTestPagerEntities() throws Exception {
        ...
        restFieldTestPagerEntityMockMvc.perform(get("/api/field-test-pager-entities?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].stringJade").value(hasItem(DEFAULT_STRING_JADE)))
            .andExpect(jsonPath("$.[*].stringRequiredJade").value(hasItem(DEFAULT_STRING_REQUIRED_JADE)))
            .andExpect(jsonPath("$.[*].stringMinlengthJade").value(hasItem(DEFAULT_STRING_MINLENGTH_JADE)))
            .andExpect(jsonPath("$.[*].stringMaxlengthJade").value(hasItem(DEFAULT_STRING_MAXLENGTH_JADE)))
            .andExpect(jsonPath("$.[*].stringPatternJade").value(hasItem(DEFAULT_STRING_PATTERN_JADE)))
            ...
            .andExpect(jsonPath("$.[*].durationJade").value(hasItem(DEFAULT_DURATION_JADE.toString())))
            .andExpect(jsonPath("$.[*].durationRequiredJade").value(hasItem(DEFAULT_DURATION_REQUIRED_JADE.toString())))
            ...
            .andExpect(jsonPath("$.[*].uuidJade").value(hasItem(DEFAULT_UUID_JADE.toString())))
            .andExpect(jsonPath("$.[*].uuidRequiredJade").value(hasItem(DEFAULT_UUID_REQUIRED_JADE.toString())))
    ...
    public void getFieldTestPagerEntity() throws Exception {
        ...
        restFieldTestPagerEntityMockMvc.perform(get("/api/field-test-pager-entities/{id}", fieldTestPagerEntity.getId()))
            ...
            .andExpect(jsonPath("$.stringJade").value(DEFAULT_STRING_JADE))
            .andExpect(jsonPath("$.stringRequiredJade").value(DEFAULT_STRING_REQUIRED_JADE))
            .andExpect(jsonPath("$.stringMinlengthJade").value(DEFAULT_STRING_MINLENGTH_JADE))
            .andExpect(jsonPath("$.stringMaxlengthJade").value(DEFAULT_STRING_MAXLENGTH_JADE))
            .andExpect(jsonPath("$.stringPatternJade").value(DEFAULT_STRING_PATTERN_JADE))
            ...
            .andExpect(jsonPath("$.durationJade").value(DEFAULT_DURATION_JADE.toString()))
            .andExpect(jsonPath("$.durationRequiredJade").value(DEFAULT_DURATION_REQUIRED_JADE.toString()))
            ...
            .andExpect(jsonPath("$.uuidJade").value(DEFAULT_UUID_JADE.toString()))
            .andExpect(jsonPath("$.uuidRequiredJade").value(DEFAULT_UUID_REQUIRED_JADE.toString()))
    ...
    public void updateFieldTestPagerEntity() throws Exception {
        ...
        assertThat(testFieldTestPagerEntity.getDurationJade()).isEqualTo(UPDATED_DURATION_JADE);
        assertThat(testFieldTestPagerEntity.getDurationRequiredJade()).isEqualTo(UPDATED_DURATION_REQUIRED_JADE);
        ...
        assertThat(testFieldTestPagerEntity.getUuidJade()).isEqualTo(UPDATED_UUID_JADE);
        assertThat(testFieldTestPagerEntity.getUuidRequiredJade()).isEqualTo(UPDATED_UUID_REQUIRED_JADE);
    ...
    public void deleteFieldTestPagerEntity() throws Exception {
        ...
        // Delete the fieldTestPagerEntity
